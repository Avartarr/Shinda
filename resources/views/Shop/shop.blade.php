                    ...
                    <div class="row">
                        ...
                        <div class="pl-lg-3 col-sm-4 offset-sm-0 offset-1 pt-3">
                            <div class="coupon-sale-content">
                                <h4 class="m-b-1 coupon-sale-text bg-white text-transform-none"> All Exclusive
                                </h4>
                                    ...
                                    <li>
                                        ...
                                        <div class="collapse show" id="widget-category-1">
                                            <ul class="cat-sublist">
                                                <li>Hair<span class="products-count">(1000)</span></li>
                                                <li>Nails<span class="products-count">(4000)</span></li>
                                                <li>Lases and make up<span class="products-count">(2000)</span></li>
                                            </ul>
                                        </div>
                                    </li>
                                </ul>
                                    ...
                                    @foreach ($featured as $featured)
                                        <div class="product-default left-details product-widget">
                                            ...
                                            <div class="product-details">
                                                <h3 class="product-title">{{ $featured->prodName }}</h3>
                                                ...
                                                <div class="price-box">
                                                    <span class="product-price">${{ $featured->price }}.00</span>
                                                </div>
                                                <!-- End .price-box -->
                                            </div>
                                            <!-- End .product-details -->
